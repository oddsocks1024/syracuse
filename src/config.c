...
/* Loads the Global and Machine Config */
void loadconfig() {
    char config_file[512];
    char *p;
    int c;

    get_config_dir_loc(config_file);
    strcat(config_file, GLOBAL_CFG_FILENAME);
    ...
    p = (char *)config_get_string(CFG_MACHINE, "MACHINE", "machine", "a3000");
    ...
    soundena = config_get_int(CFG_GLOBAL, "GLOBAL", "sound_enable", 1);
    display_mode = config_get_int(CFG_MACHINE, "MACHINE", "display_mode", DISPLAY_MODE_NO_BORDERS);
    arm_cpu_type = config_get_int(CFG_MACHINE, "MACHINE", "cpu_type", 0);
    memc_type = config_get_int(CFG_MACHINE, "MACHINE", "memc_type", 0);
    fpaena = config_get_int(CFG_MACHINE, "MACHINE", "fpa", 0);
    fpu_type = config_get_int(CFG_MACHINE, "MACHINE", "fpu_type", 0);
    firstfull = config_get_int(CFG_GLOBAL, "GLOBAL", "first_fullscreen", 1);
    dblscan = config_get_int(CFG_MACHINE, "MACHINE", "double_scan", 1);
    video_scale = config_get_int(CFG_MACHINE, "MACHINE", "video_scale", 1);
    video_fullscreen_scale = config_get_int(CFG_MACHINE, "MACHINE", "video_fullscreen_scale", FULLSCR_SCALE_FULL);
    video_linear_filtering = config_get_int(CFG_MACHINE, "MACHINE", "video_linear_filtering", 0);
    fdctype = config_get_int(CFG_MACHINE, "MACHINE", "fdc_type", 1);
    st506_present = config_get_int(CFG_MACHINE, "MACHINE", "st506_present", 0);
    stereo = config_get_int(CFG_GLOBAL, "GLOBAL", "stereo", 1);
    sound_gain = config_get_int(CFG_GLOBAL, "GLOBAL", "sound_gain", 0);
    sound_filter = config_get_int(CFG_GLOBAL, "GLOBAL", "sound_filter", 0);
    disc_noise_gain = config_get_int(CFG_GLOBAL, "GLOBAL", "disc_noise_gain", 0);
    unique_id = config_get_int(CFG_MACHINE, "MACHINE", "unique_id", 0);
    memsize = config_get_int(CFG_MACHINE, "MACHINE", "mem_size", 4096);
    p = (char *)config_get_string(CFG_MACHINE, "MACHINE", "rom_set", "riscos311");
    romset = get_romset(p);
    p = (char *)config_get_string(CFG_MACHINE, "MACHINE", "monitor_type", "multisync");
    monitor_type = get_monitor_type(p);
    p = (char *)config_get_string(CFG_MACHINE, "MACHINE", "joystick_if", "");
    ...
    p = (char *)config_get_string(CFG_MACHINE, "MACHINE","hd4_fn" ,NULL);
    ...
    hd_spt[0] = config_get_int(CFG_MACHINE, "MACHINE", "hd4_sectors", 63);
    hd_hpc[0] = config_get_int(CFG_MACHINE, "MACHINE", "hd4_heads", 16);
    hd_cyl[0] = config_get_int(CFG_MACHINE, "MACHINE", "hd4_cylinders", 100);
    p = (char *)config_get_string(CFG_MACHINE, "MACHINE","hd5_fn",NULL);
    ...
    hd_spt[1] = config_get_int(CFG_MACHINE, "MACHINE", "hd5_sectors", 63);
    hd_hpc[1] = config_get_int(CFG_MACHINE, "MACHINE", "hd5_heads", 16);
    hd_cyl[1] = config_get_int(CFG_MACHINE, "MACHINE", "hd5_cylinders", 100);
    p = (char *)config_get_string(CFG_MACHINE, "MACHINE", "renderer_driver", "auto");
    ...
    p = (char *)config_get_string(CFG_MACHINE, "MACHINE", "5th_column_fn", NULL);
    ...
    support_rom_enabled = config_get_int(CFG_MACHINE, "MACHINE", "support_rom_enabled", 1);
}

/* Saves the Global and Machine Configs */
void saveconfig() {
    char config_file[512];
    int c;
    ...
    get_config_dir_loc(config_file);
    strcat(config_file, GLOBAL_CFG_FILENAME);
    config_set_string(CFG_MACHINE, "MACHINE", "machine", machine);
    config_set_string(CFG_MACHINE, "MACHINE", "disc_name_0", discname[0]);
    config_set_string(CFG_MACHINE, "MACHINE", "disc_name_1", discname[1]);
    config_set_string(CFG_MACHINE, "MACHINE", "disc_name_2", discname[2]);
    config_set_string(CFG_MACHINE, "MACHINE", "disc_name_3", discname[3]);
    config_set_int(CFG_GLOBAL, "GLOBAL", "sound_enable", soundena);
    config_set_int(CFG_MACHINE, "MACHINE", "mem_size", memsize);
    config_set_int(CFG_MACHINE, "MACHINE", "cpu_type", arm_cpu_type);
    config_set_int(CFG_MACHINE, "MACHINE", "memc_type", memc_type);
    config_set_int(CFG_MACHINE, "MACHINE", "fpa", fpaena);
    config_set_int(CFG_MACHINE, "MACHINE", "fpu_type", fpu_type);
    config_set_int(CFG_MACHINE, "MACHINE", "display_mode", display_mode);
    config_set_int(CFG_GLOBAL, "GLOBAL", "first_fullscreen", firstfull);
    config_set_int(CFG_MACHINE, "MACHINE", "double_scan", dblscan);
    config_set_int(CFG_MACHINE, "MACHINE", "video_scale", video_scale);
    config_set_int(CFG_MACHINE, "MACHINE", "video_fullscreen_scale", video_fullscreen_scale);
    config_set_int(CFG_MACHINE, "MACHINE", "video_linear_filtering", video_linear_filtering);
    config_set_int(CFG_MACHINE, "MACHINE", "fdc_type", (fdctype == FDC_82C711) ? 1 : 0);
    config_set_int(CFG_MACHINE, "MACHINE", "st506_present", st506_present);
    config_set_string(CFG_MACHINE, "MACHINE", "rom_set", config_get_romset_name(romset));
    config_set_string(CFG_MACHINE, "MACHINE", "monitor_type", get_monitor_type_name(monitor_type));
    config_set_string(CFG_MACHINE, "MACHINE", "joystick_if", joystick_if);
    ...
    config_set_int(CFG_GLOBAL, "GLOBAL", "stereo", stereo);
    config_set_int(CFG_GLOBAL, "GLOBAL", "sound_gain", sound_gain);
    config_set_int(CFG_GLOBAL, "GLOBAL", "sound_filter", sound_filter);
    config_set_int(CFG_GLOBAL, "GLOBAL", "disc_noise_gain", disc_noise_gain);
    config_set_int(CFG_MACHINE, "MACHINE", "unique_id", unique_id);
    config_set_string(CFG_MACHINE, "MACHINE", "hd4_fn", hd_fn[0]);
    config_set_int(CFG_MACHINE, "MACHINE", "hd4_sectors", hd_spt[0]);
    config_set_int(CFG_MACHINE, "MACHINE", "hd4_heads", hd_hpc[0]);
    config_set_int(CFG_MACHINE, "MACHINE", "hd4_cylinders", hd_cyl[0]);
    config_set_string(CFG_MACHINE, "MACHINE", "hd5_fn", hd_fn[1]);
    config_set_int(CFG_MACHINE, "MACHINE", "hd5_sectors", hd_spt[1]);
    config_set_int(CFG_MACHINE, "MACHINE", "hd5_heads", hd_hpc[1]);
    config_set_int(CFG_MACHINE, "MACHINE", "hd5_cylinders", hd_cyl[1]);
    config_set_string(CFG_MACHINE, "MACHINE", "renderer_driver", video_renderer_get_name(selected_video_renderer));
    config_set_string(CFG_MACHINE, "MACHINE", "podule_0", podule_names[0]);
    config_set_string(CFG_MACHINE, "MACHINE", "podule_1", podule_names[1]);
    config_set_string(CFG_MACHINE, "MACHINE", "podule_2", podule_names[2]);
    config_set_string(CFG_MACHINE, "MACHINE", "podule_3", podule_names[3]);
    config_set_string(CFG_MACHINE, "MACHINE", "5th_column_fn", _5th_column_fn);
    config_set_int(CFG_MACHINE, "MACHINE", "support_rom_enabled", support_rom_enabled);
