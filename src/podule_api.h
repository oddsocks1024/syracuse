...
typedef struct podule_config_selection_t {
    ...
    /* Value this selection represents. Valid when parent control is CONFIG_SELECTION */
    int value;

    /* Value this selection represents. Valid when parent control is CONFIG_SELECTION_STRING */
    char *value_string;
...
typedef struct podule_t {
    ...
    /* Pointer to the name of the instance being started, so it can be used by the podule */
    char *instance_name;
} podule_t;
...
typedef struct podule_callbacks_t {
    ...
    */
    ...
    /*
        get_timer_remaining_us() - Return time until timer expires and run() is called
        @podule: podule pointer
    ...
    */
    ...
    /*
        config_get_current() - Get the value of a config item in the currently open dialogue
        @window_p: window pointer
    ...
    */
    ...
    /*
        config_get_current() - Set the value of a config item in the currently open dialogue
        @window_p: window pointer
        @id:       ID of config item
