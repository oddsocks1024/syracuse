            ...
            switch (ad1848->index) {
                case 8:
                    ...
                    switch ((val >> 1) & 7) {
                        case 0:
                            freq = base_freq / 3072;
                            ad1848->rate_divider = 48;
                            break;
                        case 1:
                            freq = base_freq / 1536;
                            ad1848->rate_divider = 24;
                            break;
                        case 2:
                            freq = base_freq / 896;
                            ad1848->rate_divider = 14;
                            break;
                        case 3:
                            freq = base_freq / 768;
                            ad1848->rate_divider = 12;
                            break;
                        case 4:
                            freq = base_freq / 448;
                            ad1848->rate_divider = 7;
                            break;
                        case 5:
                            freq = base_freq / 384;
                            ad1848->rate_divider = 6;
                            break;
                        case 6:
                            freq = base_freq / 512;
                            ad1848->rate_divider = 8;
                            break;
                        case 7:
                            freq = base_freq / 2560;
                            ad1848->rate_divider = 40;
                            break;
                    }
